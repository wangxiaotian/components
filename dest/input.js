        ...
        (function () {
            ...
            (function () {
                ...
                Text.prototype.configuration = {
                    ...
                    */
                    inputCb: function inputCb(curObj) {}
                };
            ...
            (function () {
                ...
                Select.prototype.configuration = {
                     ...
                     */
                    afterRender: function afterRender(obj) {},
                    /*
                     *  选中触发回调
                     *  @params     curOption   {jq element}    tagName:option  
                     *  @params     obj         {jq element}    tagName:select
                     */
                    trigger: function trigger(curOption, obj) {}
                };
            ...
            window.xxinput = {
                ...
                initSelect: function initSelect(options) {
                    var select = new XXinput.Select();
                    select.init(options);
                    return select;
                },
                initForm: function initForm(options) {
                    var form = new XXinput.Form();
                    form.init(options);
                    return form;
                },
                initCascade: function initCascade(options) {
                    var cascade = new XXinput.CascadeSelect();
                    cascade.init(options);
                    return cascade;
                },
                initTextarea: function initTextarea(options) {
