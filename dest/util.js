...
(function e(t, n, r) {
  function s(o, u) {
    ...
    require('babel-polyfill')(function () {
       ...
       * 通用数据请求get
       */
      Utils.getData = function (url, data, callback, _error) {
      ...
      Utils.promise = function (url, data, _error2) {
        var encodeUrl = encodeURI(url);
        //  传入的data是对象，序列化之并编码
        if ((typeof data === "undefined" ? "undefined" : _typeof(data)) === 'object') {
          data = $.param(data);
       ...
       * 通用数据请求post
       */
      Utils.postData = function (url, data, callback, _error3) {
        var encodeUrl = encodeURI(url);
        //  传入的data是对象，序列化之并编码
